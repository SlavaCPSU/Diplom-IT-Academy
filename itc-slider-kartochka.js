...
class ItcSlider {
   ...
   * @param {String} prefix
   */
  constructor(el, config = {}, prefix = 'itc-slider-kartochka__') {
   ...
   * @param {String} prefix
   */
  static getOrCreateInstance(target, config = {}, prefix = 'itc-slider-kartochka__') {
    try {
  ...
  static createInstances() {
    document.querySelectorAll('[data-slider="itc-slider-kartochka"]').forEach((el) => {
  ...
  #onSwipeStart(e) {
    if (!e.target.closest('.itc-slider-kartochka__btn')) {
      e.preventDefault();
      this.#autoplay('stop');
  ...
  #attachEvents() {
    this.#state.events = {
      ...
      'itc-slider-kartochka__transition-start': [this.#state.elItems, this.#onTransitionStart.bind(this), this.#config.loop],
  ...
  #move() {
    ...
    this.#state.elItems.dispatchEvent(new CustomEvent('itc-slider-kartochka__transition-start', {
      bubbles: true
    }));
  }
